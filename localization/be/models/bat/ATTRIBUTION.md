...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `spatial_ast.py`  | `src/slam_llm/models/SpatialAST/SpatialAST.py` + `src/slam_llm/models/SpatialAST/vision_transformer.py`                                                          | `BinauralEncoder`, `PatchEmbed_new`, `conv3x3`, and the minimal ViT (`Block`, `Attention`, `Mlp`, base `VisionTransformer`). HybridEmbed, redundant `PatchEmbed`, and training utilities removed. |
